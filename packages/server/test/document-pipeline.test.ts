 ...
 *     document — D115, and the opposite of POL-109's accept-and-warn, because conversion is not an
...
describe("POL-114 a server with NO converter (D115 — refuse, don't pretend)", () => {
...
// ─────────────────────────────────────────────────────────────────────────────
// The job feed — the console's ONLY window into a conversion (D115).
// ─────────────────────────────────────────────────────────────────────────────
