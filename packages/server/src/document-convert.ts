 ...
 *
 * REFUSE, DON'T PRETEND (D115). POL-109's prober ACCEPTS an unprobeable upload, because a file it
...
/** The sentence an operator sees when this server cannot convert documents (D115 — refuse, because a
