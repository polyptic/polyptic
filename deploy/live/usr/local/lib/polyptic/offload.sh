...
# The stage-1 config, same content as the medium's (deploy/dongle-grub.cfg.tmpl) plus our marker line.
...
# Only reached when there is ALSO no local payload: keep offering retries.
set timeout=10
set default=retry
